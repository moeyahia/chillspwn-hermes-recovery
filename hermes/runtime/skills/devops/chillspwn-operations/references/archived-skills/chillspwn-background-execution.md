...
## Bringing up the HTB/Vulnlab VPN
...
- **Reporting the blocker to Mr. Wong:** lead with one plain sentence separating "attack/creds are fine" from "network/VPN is down and the fix is on your side," THEN the technical detail — dense jargon/emoji tables confused him here. See memory on his blocker-reporting preference.