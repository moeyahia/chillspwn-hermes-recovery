...
description: "Microsoft 365 / Entra ID attack chain (2026) — user enum, AADSTS codes, conditional-access & token abuse, app-consent. Use against M365/Azure AD tenants (login.microsoftonline.com)."
