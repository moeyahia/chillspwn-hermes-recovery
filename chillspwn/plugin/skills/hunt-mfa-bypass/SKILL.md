...
description: "MFA/2FA bypass (7 patterns: not enforced on sensitive actions, response/status tamper, OTP brute, backup-code, remember-device). Use whenever 2FA gates a login or sensitive action."
