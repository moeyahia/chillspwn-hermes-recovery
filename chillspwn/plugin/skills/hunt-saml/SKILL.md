---
name: hunt-saml
description: "SAML/SSO attacks — XML Signature Wrapping (XSW), signature stripping, comment injection, IdP confusion. Use when authentication uses SAML assertions."
