...
description: "SharePoint on-prem attacks (2013 to SE) — ToolShell, anonymous endpoint/version enum, SOAP/FormDigest abuse. Use when the target runs on-prem SharePoint (_layouts/, _vti_bin/)."
