...
description: "Host-header injection — reset-poisoning to ATO, cache poisoning, routing/SSRF via Host/X-Forwarded-Host. Use when the app reflects or routes on the Host header (esp. password reset)."
