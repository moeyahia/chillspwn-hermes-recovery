---
name: hunt-k8s
description: "Kubernetes & Docker attacks — anonymous API, kubelet :10250 exec, exposed dashboards, container escape. Use when k8s/Docker/kubelet/etcd ports or dashboards are exposed."
