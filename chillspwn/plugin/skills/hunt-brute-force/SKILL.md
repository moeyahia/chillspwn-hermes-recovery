...
description: "Missing/weak rate limiting — login, OTP/2FA, reset-token, credential-stuffing brute force. Use when an endpoint accepts repeated guesses (login, OTP, coupon, token) without throttling."
