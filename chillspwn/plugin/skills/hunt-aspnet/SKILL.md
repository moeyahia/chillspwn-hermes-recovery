---
name: hunt-aspnet
description: "ASP.NET attacks — ViewState deserialization, machineKey recovery, dual-parser MAC bypass, padding-oracle. Use when fingerprint shows ASP.NET/IIS (__VIEWSTATE, .aspx)."
