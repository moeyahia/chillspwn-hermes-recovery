...
description: "Race conditions via HTTP/2 single-packet & parallel requests — limit-overrun, double-spend, TOCTOU. Use on coupon redemption, withdrawals, votes, invites — anything once-per-user."
