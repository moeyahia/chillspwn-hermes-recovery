...
description: "Malicious file upload — webshell RCE, SVG/HTML XSS, XXE-in-DOCX SSRF, path traversal via filename, content-type/extension bypass. Use wherever the app accepts uploads."
