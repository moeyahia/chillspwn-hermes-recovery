---
name: hunt-csrf
description: "Cross-site request forgery on state-changing requests. Use when actions lack anti-CSRF tokens; covers SameSite-Lax sibling-domain, method-override, JSON-CSRF and token-validation bypasses."
