---
name: hunt-dispatch
description: "/hunt orchestrator loader — fingerprints the target and loads the matching platform/attack skills. Use to auto-route a fresh target to the right skills."
