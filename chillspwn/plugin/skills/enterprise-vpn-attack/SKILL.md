...
description: "SSL-VPN / remote-access appliance attacks — Cisco ASA/AnyConnect, Fortinet, Citrix NetScaler, Palo Alto. Use when a VPN/gateway appliance is in scope (login portals, known CVEs)."
