---
name: hunt-dom
description: "Client-side DOM bugs — DOM clobbering, postMessage hijacking (missing origin checks), client-side prototype pollution, DOM-XSS sinks. Use with heavy client JS / postMessage / iframes."
