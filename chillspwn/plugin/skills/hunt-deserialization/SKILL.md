...
description: "Insecure deserialization RCE — Java (ysoserial), PHP object injection (phpggc), Python pickle, .NET BinaryFormatter/ViewState. Use when serialized blobs appear (base64 Java/PHP, ViewState, cookies)."
