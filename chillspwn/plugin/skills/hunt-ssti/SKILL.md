---
name: hunt-ssti
description: "Server-side template injection (Jinja2/Twig/Freemarker/ERB/Velocity/Smarty). Use when input renders through a template (greetings, names, email/PDF templates); {{7*7}} evaluates."
