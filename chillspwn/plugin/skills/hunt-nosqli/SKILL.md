---
name: hunt-nosqli
description: "NoSQL injection — MongoDB operator injection (where/ne/gt/regex), auth bypass, CouchDB/Redis. Use when the backend is NoSQL and JSON inputs reach queries (especially login)."
