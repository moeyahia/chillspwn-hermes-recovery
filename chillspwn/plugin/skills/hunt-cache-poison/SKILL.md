...
description: "Web cache poisoning & deception — unkeyed headers (X-Forwarded-Host, X-HTTP-*), cache-key flaws. Use when a CDN/cache fronts the app and reflected input or redirects are cacheable."
