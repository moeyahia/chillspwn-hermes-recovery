---
name: hunt-websocket
description: "WebSocket attacks — Cross-Site WebSocket Hijacking (CSWSH), missing Origin validation, no auth on handshake, message injection. Use when the app opens ws or wss connections."
