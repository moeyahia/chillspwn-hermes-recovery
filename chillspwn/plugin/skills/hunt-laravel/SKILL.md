---
name: hunt-laravel
description: "Laravel attacks — APP_DEBUG stack/env leakage, Telescope/Horizon exposure, deserialization, exposed .env. Use when fingerprint shows Laravel/PHP (ignition, /telescope, X-Powered-By)."
