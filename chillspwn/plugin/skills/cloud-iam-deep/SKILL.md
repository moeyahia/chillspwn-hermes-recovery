---
name: cloud-iam-deep
description: "Cloud IAM privilege escalation (AWS/Azure/GCP) — post-credential-discovery escalation paths & external exploitation. Use after finding cloud keys/tokens, or when assessing cloud IAM."
agents: CloudSentinel, Intigriti Researcher
