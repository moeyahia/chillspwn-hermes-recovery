...
description: "TLS/SSL & DNS misconfig — missing HSTS, weak ciphers, expired/invalid certs, mTLS gaps, DNS issues. Use during recon or perimeter-hygiene review."
agents: WebBreaker, ReconScout, CloudSentinel, Intigriti Researcher
