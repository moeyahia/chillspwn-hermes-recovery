...
description: "REST/API security misconfig — mass assignment, JWT attacks (alg=none/kid/weak-secret), prototype pollution, HTTP verb tampering. Use when testing JSON/REST APIs or token auth."
