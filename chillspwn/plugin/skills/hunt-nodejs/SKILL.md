---
name: hunt-nodejs
description: "Node.js attacks — prototype-pollution to RCE (lodash/merge), Express trust-proxy & path confusion, dependency gadgets. Use when fingerprint shows Node/Express."
