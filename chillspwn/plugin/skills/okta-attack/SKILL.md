---
name: okta-attack
description: "Okta-as-IdP attacks — tenant discovery, user enumeration, factor/flow analysis, app misconfig. Use when SSO is Okta (okta.com domains or Okta in metadata)."
