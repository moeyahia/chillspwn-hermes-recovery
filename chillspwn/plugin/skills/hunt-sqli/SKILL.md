---
name: hunt-sqli
description: "Detect & exploit SQL injection — error/boolean/time-blind/UNION/stacked (+NoSQL). Use when input reaches a query: search, filters, id/sort params, login, or DB errors leak."
