...
description: "Spring Boot attacks — exposed Actuator (heapdump/env/loggers/shutdown), SpEL injection, Spring Cloud. Use when fingerprint shows Spring/Java, /actuator, or whitelabel error pages."
