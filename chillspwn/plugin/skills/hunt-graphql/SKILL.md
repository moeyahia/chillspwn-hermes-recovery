---
name: hunt-graphql
description: "GraphQL abuse — introspection, node()/GID IDOR, mutation authz gaps, batching/alias DoS, injection. Use when a /graphql endpoint or GraphQL queries are present."
