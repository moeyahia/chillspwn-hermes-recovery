---
name: hunt-xxe
description: "XML external entity injection — file read, SSRF, OOB exfil. Use when the app parses XML/SVG/Office docs (DOCX/XLSX/PPTX), SOAP, SAML, RSS, or accepts SVG/document uploads."
