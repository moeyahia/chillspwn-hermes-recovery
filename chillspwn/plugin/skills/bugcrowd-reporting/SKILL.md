...
description: "Bugcrowd-specific reporting — VRT category mapping/fallback, severity requests, out-of-scope rebuttals. Use when submitting to or disputing a finding on Bugcrowd."
