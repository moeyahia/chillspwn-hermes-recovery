---
name: hunt-idor
description: "IDOR / broken object-level authorization. Use when a request carries a swappable object reference — numeric/UUID/hash IDs, filenames, account/tenant params, or GraphQL node IDs."
