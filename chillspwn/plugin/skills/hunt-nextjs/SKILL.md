---
name: hunt-nextjs
description: "Next.js attacks — Server Actions abuse, middleware auth bypass via static-asset paths, cache/SSRF. Use when the target runs Next.js (_next/, build manifests, x-powered-by)."
