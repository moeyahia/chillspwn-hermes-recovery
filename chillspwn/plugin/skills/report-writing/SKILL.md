---
name: report-writing
description: "Bug-bounty report templates (H1/Bugcrowd/Intigriti/Immunefi) — impact-first writing, human tone, CVSS. Use when drafting a platform submission (use pentest-report-pdf for dashboard PDFs)."
agents: ReportSmith, Intigriti Researcher
---
