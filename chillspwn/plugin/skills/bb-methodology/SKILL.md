---
name: bb-methodology
description: "5-phase bug-bounty methodology — what to do next at session start, on a new target, or when stuck. Load at the start of a session or when you need a hunting plan."
