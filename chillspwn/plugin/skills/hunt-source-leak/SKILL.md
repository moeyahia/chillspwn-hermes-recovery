...
description: "Exposed source & build artifacts — JS source maps (.js.map), Swagger/OpenAPI, .git/.env/.svn, backup files. Use during recon or when JS bundles/maps are reachable."
agents: SecretHunter, WebBreaker, Intigriti Researcher
