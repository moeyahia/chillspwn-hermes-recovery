---
name: hunt-session
description: "Session-management flaws — fixation (no rotation on login), weak invalidation on logout/password-change, predictable/long-lived tokens. Use when auditing cookies & session lifecycle."
