---
name: web2-recon
description: "Web2 recon pipeline — subdomain enum (subfinder/Chaos/assetfinder), live hosts (dnsx/httpx), crawling (katana), nuclei. Use at the start to map a target web attack surface."
agents: ReconScout, WebBreaker, Intigriti Researcher
---
