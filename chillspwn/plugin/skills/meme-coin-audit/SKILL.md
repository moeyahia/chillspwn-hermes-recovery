...
description: "Token/meme-coin rug-pull audit — honeypot, hidden mint, fee manipulation, LP-lock bypass, Solana SPL. Use when vetting a token contract for rug-pull risk."
