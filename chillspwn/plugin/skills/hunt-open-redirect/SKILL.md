...
description: "Open redirect — off-domain bounces via redirect params; chain to OAuth token theft & phishing. Use on next/url/return/redirect/callback params and post-login/logout redirects."
