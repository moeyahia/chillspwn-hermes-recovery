---
name: hunt-cors
description: "CORS misconfiguration to cross-origin data theft. Use when responses set Access-Control-Allow-Origin dynamically — test origin reflection w/ credentials, null origin, weak subdomain regex."
