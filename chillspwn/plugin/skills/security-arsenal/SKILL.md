...
description: "Payload library + bypass tables, wordlists, gf pattern names, and the always-rejected vs valid-with-chain finding lists. Load when you need a working payload/bypass or to sanity-check a finding."
