---
name: hunt-rce
description: "Achieve remote code execution — command injection, unsafe eval/exec, argument injection, media/PDF/ffmpeg processors. Use when input reaches OS commands/a shell or a known-vuln component."
