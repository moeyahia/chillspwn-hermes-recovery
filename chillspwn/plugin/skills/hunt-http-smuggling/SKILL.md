...
description: "HTTP request smuggling — CL.TE/TE.CL/H2.CL/H2.TE desync. Use when a front-end proxy/CDN forwards to a back-end (esp. HTTP/2 front-ends) to poison other users requests."
