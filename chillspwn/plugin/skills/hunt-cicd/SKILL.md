---
name: hunt-cicd
description: "CI/CD pipeline attacks — GitHub Actions workflow injection (pull_request_target Pwnrequest), self-hosted runner abuse, secret exfil. Use when the repo/build uses GH Actions/CI."
