---
name: hunt-misc
description: "Catch-all sweep for less-common web bugs — odd headers, debug endpoints, info leaks, edge-case injections. Use as a sweep when standard classes do not fit, or for misc low-hanging findings."
