...
description: "Detect client SOC/IR activity & security-state changes DURING an engagement — patch detection, monitoring signs. Use mid-engagement to spot blue-team response."
