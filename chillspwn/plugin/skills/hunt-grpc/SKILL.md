---
name: hunt-grpc
description: "gRPC attacks — server-reflection enumeration, missing auth/metadata stripping, message tampering. Use when the target exposes gRPC/HTTP2 services or proto endpoints."
