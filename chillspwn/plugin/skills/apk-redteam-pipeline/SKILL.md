...
description: "Android APK red-team pipeline — acquire (Play/apkpure/apkmirror), jadx decompile, secret/endpoint grep. Use when a mobile APK is in scope."
agents: ReverseSage, SecretHunter, Intigriti Researcher
