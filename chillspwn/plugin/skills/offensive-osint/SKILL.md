...
description: "External recon arsenal — concrete probes, dorks, regexes, curl one-liners, wordlists for authorized recon. Use when gathering assets, exposure, and attack surface on a target."
agents: OSINTSeeker, ReconScout, Intigriti Researcher
---
