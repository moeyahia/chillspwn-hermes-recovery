---
name: hunt-lfi
description: "LFI/RFI & path traversal — /etc/passwd read, log poisoning to RCE, PHP filter/wrapper chains. Use when a param names a file/path/page/template/include/download."
