...
description: "Pre-report validation — 7-Question Gate + 4 pre-submission gates + always-rejected list. Use BEFORE writing any report to confirm a finding is real, in-scope, and impactful."
agents: Intigriti Researcher, WebBreaker
---
