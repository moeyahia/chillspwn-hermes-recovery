---
name: hunt-ldap
description: "LDAP & XPath injection — auth bypass, blind attribute exfil, AD user/group enum. Use when input feeds an LDAP/AD lookup or XPath query (login, directory/people search)."
