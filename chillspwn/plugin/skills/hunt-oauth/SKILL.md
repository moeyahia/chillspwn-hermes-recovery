---
name: hunt-oauth
description: "OAuth/OIDC flaws — redirect_uri bypass, state/CSRF, code/token leakage, account linking, implicit-flow theft. Use when login uses OAuth/SSO/Sign-in-with."
