export const INTERACTION_MANIFEST_NAMESPACE = "chillspwn.command-os-v2" as const;
...
export interface InteractionManifest {
  ...
  readonly application: "CHILLSPWN // COMMAND OS";
...
export function validateInteractionManifest(value: unknown): InteractionManifest {
  ...
  if (root.application !== "CHILLSPWN // COMMAND OS") errors.push("manifest.application is not the V2 product identity");
