...
export const V2_SESSION_COOKIE = "chillspwn_command_os_v2_session" as const;
export const V2_CSRF_COOKIE = "chillspwn_command_os_v2_csrf" as const;
export const V2_CSRF_HEADER = "x-command-os-v2-csrf" as const;
...
/** Stateless, signed, local-only browser sessions for the isolated V2 API. */
export class LocalSessionAuth {
  ...
  private sign(payload: string): string {
    return createHmac("sha256", this.operatorToken)
      .update("chillspwn.command-os-v2.session.v1\0", "utf8")
      .update(payload, "utf8")
      .digest("base64url");
  }
}
