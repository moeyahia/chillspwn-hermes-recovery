...
describe("OperationalTruthRouter V2 boundary", () => {
  test("requires a trusted lease resolver, rejects imported ownership, allows heartbeat, and fences takeover and replay", async () => {
    ...
    fixture.database.prepare("UPDATE missions SET control_plane = 'command_os_v2' WHERE id = 'mission-one'").run();
    ...
    fixture.database.prepare("UPDATE runs SET control_plane = 'command_os_v2' WHERE id = 'run-one'").run();
