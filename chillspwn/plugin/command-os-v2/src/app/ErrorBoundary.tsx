...
export class RouteErrorBoundary extends Component<{ children: ReactNode; resetKey: string }, { error?: Error }> {
  ...
  componentDidCatch(error: Error, info: ErrorInfo) {
    void fetch("/api/v2/client-log", {
      ...
      body: JSON.stringify({ level: "error", domain: "command-os-v2-route", message: error.message, componentStack: info.componentStack }),
    }).catch(() => undefined);
  }
    ...
    return (
      <div className="os-page">
        <div className="os-route-error" role="alert">
          ...
          <h1>This Command OS surface could not render</h1>
