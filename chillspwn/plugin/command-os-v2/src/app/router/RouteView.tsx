...
function Redirect({ to }: { to: string }) {
  ...
  return <div className="os-page"><LoadingPanel label="Opening Command OS surface" /></div>;
}

function LoadingRoute() {
  return <div className="os-page"><LoadingPanel label="Loading Command OS surface" /></div>;
}
...
export function RouteView() {
  ...
  else if (pathname === "/legacy") route = <Redirect to="/" />;
