...
export function BrainEmpty({ kind = "brain", title, description, action }: {
  ...
  const imageAvif = assetUrl(`brand-v2/optimized/${image}.avif`);
  const imageWebp = assetUrl(`brand-v2/optimized/${image}.webp`);
  return (
    <div className="brain-empty">
      <picture aria-hidden="true">
        <source srcSet={imageAvif} type="image/avif" />
        <img src={imageWebp} width="512" height="512" alt="" loading="lazy" />
      </picture>
