...
export function RegistryMissionIntakePage({ journey }: { readonly journey: Journey }) {
  ...
  const description = isAutonomous
    ...
    : "ChillsPwn resolves a durable Guided mission from authorization and one target, then explains one represented step at a time.";
