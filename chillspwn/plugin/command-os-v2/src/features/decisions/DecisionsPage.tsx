 ...
 * Earlier decisions stored the action fields directly. A conflicting legacy
...
export default function DecisionsPage() {
  ...
  return <div className="os-page"><PageHeader eyebrow="Deliberate control" title="Decisions" description="Exact Guided-step decisions and real Autonomous exceptions. Autonomous runs never wait here for routine approval." actions={<StreamState />} />
    ...
    {readiness.data?.execution.guided === "unavailable" && <p className="os-guided-inline-warning" role="status">Exact Guided runtime controls are read-only because this V2 process has no callable Guided provider/runtime boundary. Connect and attest that boundary before executing a represented step.</p>}
