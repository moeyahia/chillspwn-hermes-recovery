    ...
    <section className="os-guided-commander" aria-labelledby="guided-commander-title">
      ...
      {!executionAvailable && <div className="os-guided-inline-warning" role="status">
        ...
        {availabilityPending
          ...
          : "No callable planning-only provider and exact-step runtime boundary are attached to this V2 process. Review remains read-only; connect a compatible Guided provider and runtime, then recheck System readiness."}
      </div>}
