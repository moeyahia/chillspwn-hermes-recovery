...
export const v24OperationalTruthMigration: Migration = {
  ...
  sql: `
ALTER TABLE missions ADD COLUMN control_plane TEXT NOT NULL DEFAULT 'command_os_v2'
  CHECK (control_plane IN ('legacy', 'command_os_v2'));
ALTER TABLE runs ADD COLUMN control_plane TEXT NOT NULL DEFAULT 'command_os_v2'
  CHECK (control_plane IN ('legacy', 'command_os_v2'));

CREATE TABLE control_plane_leases (
  run_id TEXT PRIMARY KEY REFERENCES runs(id) ON DELETE CASCADE,
  control_plane TEXT NOT NULL CHECK (control_plane IN ('legacy', 'command_os_v2')),
