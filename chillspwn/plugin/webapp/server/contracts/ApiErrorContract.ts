...
export function v2JsonBodyError(
  ...
  sendV2Error(response, traceId, tooLarge
    ? {
        ...
        message: "Command OS request body exceeds the configured limit",
    ...
    : unsupported
      ? {
          ...
          message: "Command OS request encoding is unsupported",
      ...
      : {
          ...
          message: "Command OS request body is not valid JSON",
...
export function v2NotFound(
  ...
  sendV2Error(response, traceId, {
    status: 404,
    code: "command_os_route_not_found",
    message: "Command OS route was not found",
    humanMessage: "The requested Command OS endpoint does not exist.",
    retryable: false,
    category: "not_found",
