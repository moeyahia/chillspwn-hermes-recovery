...
export const AGENT_ROSTER: AgentSpec[] = [
  ...
  },
  {
    ...
    outputContract: "WorkerResult = final report (canonical branded template) + evidence bundle + proposed lessons (evidence-backed, secret-free).",
    evidenceRequirements: "Aggregates every specialist's evidenceIds; redacts secrets; proposed lessons require evidenceIds+sourceRunId.",
    handoffRules: [],
