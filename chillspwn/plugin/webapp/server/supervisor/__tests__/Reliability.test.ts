...
describe("budget enforcement", () => {
  test("permits the exact limit and rejects projected overflow atomically", () => {
    ...
    expect(overflow.exhausted).toEqual(["estimatedCost", "toolCalls"].sort((a, b) =>
      ["wallClockMs", "providerTokens", "estimatedCost", "toolCalls"].indexOf(a) -
      ["wallClockMs", "providerTokens", "estimatedCost", "toolCalls"].indexOf(b),
    ));
  });
