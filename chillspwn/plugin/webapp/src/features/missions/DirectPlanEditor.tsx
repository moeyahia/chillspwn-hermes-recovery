...
export function DirectPlanEditor({
  ...
  return <Card className="os-direct-plan-editor" aria-labelledby="direct-plan-editor-heading">
    ...
    <p>{editRequest
      ...
      : <>Choose one exact graph change. Command OS creates a versioned <span className="os-mono">PlanChangeRequest</span> with optimistic run and plan versions; the active plan changes only after a separate valid review and apply action.</>}</p>
