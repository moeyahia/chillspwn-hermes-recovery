    ...
    <section className="os-journey-grid" aria-label="Start a mission">
      <article className="os-journey-card os-journey-card--autonomous">
        ...
        <div className="os-journey-content">
          ...
          <h2>Go Autonomous</h2>
          <p>Define the authorized outcome and operating boundaries once. ChillsPwn plans, delegates, recovers, validates, and reports without routine involvement.</p>
      ...
      <article className="os-journey-card os-journey-card--guided">
        ...
        <div className="os-journey-content">
          ...
          <p>Work step by step. ChillsPwn explains the path, recommends one bounded action, waits for your decision, interprets results, and preserves the record.</p>
          <div className="os-journey-readiness">
          ...
          {data.missions.length === 0 ? (
            ...
            <div className="os-operation-list">
              {data.missions.map((mission) => (
                <ButtonLink key={mission.id} href={missionHref(mission)} variant="quiet" className="os-operation-row">
...
export default function OverviewPage() {
  const overview = useQuery("command-os-overview", fetchOverview, { staleTime: 10_000 });
  return (
    <div className="os-page os-overview-page">
      <CommandCenterAmbient />
      <PageHeader eyebrow="Mission control" title="Command Center" description="Live operational truth, readiness, and the next decision that matters." />
