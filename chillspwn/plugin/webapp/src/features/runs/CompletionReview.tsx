  ...
  return <section className="os-completion-review" aria-labelledby={`completion-review-${run.id}`}>
    ...
    <div className="os-completion-grid">
      ...
      <Card aria-label="Terminal run budget review">
        ...
        {!evaluation && <p className="os-muted">Budget usage is unknown because no canonical terminal evaluation is available. ChillsPwn does not infer usage from UI activity.</p>}
        {evaluation && <>
    ...
    <Card className="os-follow-up-review">
      ...
      <form className="os-review-form" onSubmit={(event) => {
        ...
        <fieldset>
          ...
          <p className="os-muted">Selection makes a lesson eligible for this plan. ChillsPwn records reuse only if the planner actually cites the verified lesson and explains its influence.</p>
        </fieldset>
