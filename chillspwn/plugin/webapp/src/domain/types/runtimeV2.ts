...
export interface MissionRuntimeSnapshot { schemaVersion: "2.1"; mission: RuntimeMission; runs: RuntimeRun[] }
export interface RunSnapshot { schemaVersion: "2.1"; run: RuntimeRun; latestCheckpoint: Record<string, unknown> | null }
export interface RunPage { schemaVersion: "2.1"; items: RuntimeRun[] }
...
export interface PlanStep {
  ...
  assignedAgentId: string; riskClass: string; successCriteria: string[]; action: PlannedAction;
...
export interface PlansSnapshot { schemaVersion: "2.1"; items: RunPlan[] }
...
export interface DecisionsSnapshot { schemaVersion: "2.1"; items: GuidedDecision[] }
