...
| High | Retained Hermes dependency snapshots have open alerts | GitHub reports 121 open Dependabot alerts across retained Hermes lockfiles: 3 critical, 30 high, 58 moderate, and 30 low | Triage and remediate each retained component in separately tested dependency updates. Do not describe the whole repository as dependency-clean. The deployed ChillsPwn webapp audit is separately clean. |
